...
**Layout.** Dense by design and never scrolling. The **Command** tab is a
single-screen grid — a five-tile KPI rail over nine compact cards — that carries
...
**Controls.** Year, scope and appearance live in the left sidebar, and one
...
| Tab | Sub-views | What it answers |
|---|---|---|
| **Command** | — | The whole argument on one screen: priority queue, what drives each score, the rate-vs-volume divergence, monthly loss rate, water by district, loss concentration, burst-risk bands, loss composition, criticality vs LIPS |
| **Overview** | Ranking · Full schedule · Recovery curve | The four-factor LIPS ranking and its component profile, the downloadable schedule, and how far a crew programme gets under each queue ordering |
| **Loss Dynamic** | Rate vs Volume · Loss Composition | The two measures rank plants oppositely, quantified per plant; physical vs commercial split and whether leakage tracks bursts, age and pressure |
